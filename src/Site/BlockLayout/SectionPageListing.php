...
class SectionPageListing extends AbstractBlockLayout
{
    ...
    public function onHydrate(SitePageBlock $block, ErrorStore $errorStore)
    {
        ...
        $data['includeCurrentPage'] = $data['includeCurrentPage'];
                         ...
                         SitePageRepresentation $page = null, SitePageBlockRepresentation $block = null)
    {
        ...
        $includeCurrentPage = new Checkbox("o:block[__blockIndex__][o:data][includeCurrentPage]");
        $includeCurrentPage->setLabel('Include parent page in listing');
        ...
        if ($block) {
            ...
            $includeCurrentPage->setAttribute('value',$block->dataValue('includeCurrentPage'));
        } else {
        ...
        $html .= '<a href="#" class="collapse" aria-label="collapse"><h4>' . $view->translate('List Options'). '</h4></a>';
        $html .= '<div class="collapsible">';
        $html .= $view->formRow($includeCurrentPage);
        $html .= '</div>';
        $html .= '<a href="#" class="collapse" aria-label="collapse"><h4>' . $view->translate('Card and Feature Options'). '</h4></a>';
        $html .= '<div class="collapsible">';
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block) {
        ...
        $pages = $this->sectionManager->getPagesBySection($data['section'],!empty($data['itemCount']) ? $data['itemCount'] : null,$data['includeCurrentPage']);
        ...
        return $view->partial($data['template'], [
            ...
            'targetID' => '#' . $region,
            'includeCurrentPage' => $data['includeCurrentPage'],
        ]);
    }
