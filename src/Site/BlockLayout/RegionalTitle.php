...
class RegionalTitle extends AbstractBlockLayout
{
    /**
     * @var HtmlPurifier
     */
    ...
    {
        return 'Regional Title'; // @translate
    }
    ...
    {
        $data = $block->getData();
        $html = isset($data['title']) ? $this->htmlPurifier->purify($data['title']) : '';
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial(
            'site-admin/block-layout/regional-title.phtml',
            [
                'titleform' => $view->formRow($title),
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block) {
        ...
        return $view->partial(
            'common/block-layout/regional-title.phtml',
            [
                'title' => $data['title'],
                'html' => $data['html'],
                'blockId' => $block->id(),
