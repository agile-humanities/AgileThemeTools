...
class SectionIntroSplash extends AbstractBlockLayout
{
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
        ...
        return $view->partial('common/block-layout/section-intro-splash', [
            ...
            'titleSlideAttachment' => $attachments ? $attachments[0] : '',
            'titleSlideItem' =>  $attachments ? $attachments[0]->item() : '',
            'titleSlideMedia' => $attachments && $attachments[0]->media() ? $attachments[0]->primaryMedia() : '',
